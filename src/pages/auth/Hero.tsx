    ...
    <div id="home" className="w-full h-[600px] flex items-center justify-center relative">
        <div className="w-[90%] h-[100%] flex items-center justify-center">
            ...
            <div className="absolute top-[40%] left-[5%] text-white ">
                <h2 className="text-[40px] lg:w-[40%]  small:w-[90%] small:text-[28px] md:w-[60%] px-2  bg-slate-400  bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-30 border border-gray-100 rounded-[3px]">Waste Management For A Cleaner Future And Better Education</h2>
                <br/>
